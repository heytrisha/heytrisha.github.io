...
export function Work({ projects, basePath, images }: Properties) {
    ...
    <section id="work" tabIndex={-1} className="py-24">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mb-16 text-center">
          ...
          <p className="text-muted-foreground mt-3">Selected projects and case studies</p>
        </div>
      </div>
      ...
      {projects.length > 0 ? (
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="border-foreground/10 bg-card rounded-xl border p-12 text-center">
